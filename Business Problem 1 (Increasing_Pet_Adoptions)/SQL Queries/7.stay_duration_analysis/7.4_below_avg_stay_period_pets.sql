/* 
 Query: Identify pets with below-average stay periods by species
 Purpose: This query calculates the stay period of each pet and compares it to the species-specific average, 
 identifying pets whose stay period is below the average for their species.
 */
WITH stay_period AS (
...
avg_species AS (
    ...
    GROUP BY
        species_name
) -- Retrieve pets whose stay period is below the species average
SELECT
    sp.pet_id,
    sp.species_name,
...
/*
 ...
 - A table was created for pets with above-average and below-average stay periods and was later merged 
 to streamline data analysis and reporting. 
 - This approach can be highlighted in the README to demonstrate handling of segmented data.
 */